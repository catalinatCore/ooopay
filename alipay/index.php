...
if ($order->code == 300000) {
  ...
  // 随机选择支付
  $payments = array(29); // from ooshop 29,  // 24 = 王东林,
  ...
  <div class="qrbox clearfix">
    <div class="left">
      <div class="qrcon">
        ...
        <div class="price">￥<?php echo $_GET['money']; ?></div>
        <div align="center" style="position:relative;">
          <img src="<?php echo $qrcode; ?>" style="width: 230px;height: 230px;margin-bottom: 10px;" alt="">
        </div>
        <div class="bottom">
  ...
  <script type="text/javascript">
    (function($) {
      ...
      function queryOrderStatus() {
        $.ajax({
          type: 'get',
          url: 'https://ooopay.in/order/alipay/check.php',
          data: {
            name: order_id,
            method: 'query'
          },
